...
IconManager::IconManagerImpl::IconManagerImpl(IconManager *parent) : q(parent) {
    ...
    category_icon_names_map = {
        ...
        {OBJECT_CATEGORY_SUBNET, {"preferences-system-network", "preferences-system-network-symbolic"}},
        {OBJECT_CATEGORY_SITES_CONTAINER, {"folder", "folder-symbolic"}},
        {OBJECT_CATEGORY_SUBNET_CONTAINER, {"folder", "folder-symbolic"}},
        {OBJECT_CATEGORY_INTER_SITE_TRANSPORT_CONTAINER, {"folder", "folder-symbolic"}},
        {OBJECT_CATEGORY_INTER_SITE_TRANSPORT, {"emblem-system", "emblem-system-symbolic"}},
        {OBJECT_CATEGORY_SITE_LINK, {"emblem-system", "emblem-system-symbolic"}},
        {OBJECT_CATEGORY_SITE_LINK_BRIDGE, {"emblem-shared","emblem-shared-symbolic"}},
        {OBJECT_CATEGORY_NTDS_SITE_SETTINGS, {"settings-configure", "settings-configure-symbolic"}},
        // {OBJECT_CATEGORY_SERVER, {"preferences-desktop"}},
